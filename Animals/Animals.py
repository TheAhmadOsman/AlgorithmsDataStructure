...
########################################################################
#
# CS 160 - Week 3 Exercise - Animal Class.
# Purpose: Simulating a zoo through Animal Class and Inheritance.
#
...
class Bird(Animal):
    ...
    def __str__(self):
        ...
        # Task 1d: if a bird if not a flying one, return "Non-flying " +
        # super().__str__()
        else:
...
class Mammal(Animal):
    ...
    def __init__(self, spec_, age_, color_, habitat_):
        ...
        super().__init__(spec_, age_, color_)
        # Task 2b: initialize private property _habitat if habitat_ is "Land",
        # "Sea", "Air", or "Tree"
...
class Parrot(Bird):
    ...
    def __init__(self, age_, color_, talking_):
        # Task 3a: call the constructor of the superclass with "Parrot" as
        # species and flying set to True
    ...
    def sound(self):
        ...
        # Task 3d: if a parrot is not talking, return "nothing" (word)
        else:
            return "nothing"
...
class Dog(Canine):
    ...
    def __init__(self, age_, color_):
        # Task 4a: call the constructor of the superclass with "Dog" as species
        # and habitat set to "Land"
...
class BobCat(Feline):
    ...
    def __init__(self, age_, color_, habitat_):
        # Task 5a: call the constructor of the superclass with "Bobcat" as
        # species
        super().__init__("Boobcat", age_, color_, habitat_)

    def __str__(self):
        # Task 5b: return string must include color, habitat, species, and age
        return self._spec + " of color " + self._color + " and age " + str(self._age) + " that habitat " + self._habitat
